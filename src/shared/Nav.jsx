...
const Nav = () => {
  ...
  const navLinks = (
    <>
      ...
      <li>
        <NavLink to="/allArt">Product</NavLink>
      </li>
      <li>
        <NavLink to="/addCraft">Services</NavLink>
      </li>
      <li>
        <NavLink to="/myArtCraft">Responsibility</NavLink>
      </li>
      <li>
  ...
  return (
    <div className="max-w-6xl mx-auto mb-24">
      <div className="navbar text-black py-2 lg:px-10 bg-blue-600 bg-opacity-60 fixed top-0 left-0 right-0 z-50 shadow-lg">
