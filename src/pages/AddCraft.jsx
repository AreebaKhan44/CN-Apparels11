...
const AddCraft = () => {
  ...
  return (
    <div className="my-10">
      ...
      <MyHeader></MyHeader>
      <section className="p-10 bg-blue-200 text-gray-900">
        <form
          ...
          <fieldset className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm bg-gray-100">
            ...
            <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
              ...
              <div className="col-span-full sm:col-span-3">
                ...
                <select id="subcategory_Name"
                  ...
                  className="w-full rounded-md focus:ring focus:ring-opacity-75 text-gray-900 focus:ring-blue-400 border-gray-700 p-3"
            ...
            <div class="flex justify-center items-center mx-auto">
              <div class="text-center mx-auto">
                <button class="btn w-32 bg-blue-700 text-white">
                  Add item
                </button>
              </div>
            </div>
