...
const CartItem = ({ cardItem }) => {
  ...
  return (
    <div className="mx-auto max-w-6xl my-5 ">
      <div className="max-w-xs rounded-md shadow-md bg-blue-200 text-gray-900">
        <img
          src={  image}
          alt=""
        ...
        <div className="flex flex-col justify-between p-6 space-y-8">
          ...
          <button
            type="button"
            className="flex items-center justify-center w-full p-3 font-semibold tracking-wide rounded-md bg-blue-700 h-5 text-gray-900"
          >
